...
public class GUIFood extends javax.swing.JFrame {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        //FoodTypeEnum type = (FoodTypeEnum) this.cboType.getSelectedItem();
        if (strId.isEmpty() || strName.isEmpty()) {
            return;
        }
        FindByIdCommand finder = new FindByIdCommand();
        finder.setFoodId(Integer.parseInt(strId));
        invoker.setCommand(finder);
        invoker.execute();
        Food tmpFood = finder.getFood();
        if(tmpFood == null){
            JOptionPane.showMessageDialog(null, "El componente no se encuentra registrado", 
                    "NOT_FOUND", JOptionPane.WARNING_MESSAGE);
            return;
        }
        invoker.setCommand(new DeleteByIdCommand(tmpFood));
        invoker.execute();
